...
NPROC="${NPROC:-1}"
OUTPUT_DIR="./outputs"
CHECKPOINTS_DIR="${OUTPUT_DIR}/checkpoints/uq_rmse_0625"
...
# GPUS=$GPUS NPROC=$NPROC CHECKPOINTS_DIR=$REG_DIR CONFIG=$CONFIG_FILE_REG bash scripts/01_train_regression_unet.sh

...
CONFIG_FILE_REMATCH_REG="config_training_swinir_regression.yaml"
CONFIG_FILE_REMATCH_DIFF="config_training_rematchs_diffusion.yaml"
CONFIG_FILE_GEN="config_generate_swinir.yaml"

# GPUS=$GPUS NPROC=$NPROC CHECKPOINTS_DIR=$CHECKPOINTS_DIR CONFIG=$CONFIG_FILE_REMATCH_REG bash scripts/01_train_swinir_regression.sh
